<template>
  <v-dialog v-model="dialogUpdate" persistent width="560">
    <v-card>
...
export default {
  ...
  data() {
    return {
      ...
      selectedClass: this.dialogValues.class,
      selectedType: this.dialogValues.type,
      hint: this.dialogValues.hint,
      relatedPoint: this.dialogValues.relatedPoint,
      pos: {
        x: this.dialogValues.pos.x,
        y: this.dialogValues.pos.y
      },
      pointIndex: this.dialogValues.index,
      flagIUpdated: false
      //
    };
  },
